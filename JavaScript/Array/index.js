...
// let a = (arr.slice(2,5));
// console.log(a);
// // console.log(arr);//orginal array remain same.

// splice
// console.log(arr);
// let newsplice = arr.splice(2,5);
// console.log(newsplice);
// console.log(arr);//changes occur in original array.
...
// let abc = [2,1,4,1];
// console.log(Array.isArray(abc));//check for array
